		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-9" style="padding-right: 30px">
					<h3 style="color: #ffc107; font-size: 30px;text-transform: uppercase;">Store Name</h3>
					...
					<div class="col-md-3" style="padding-top: 60px;padding-left: 60px;">
					<h4 style="font-size: 48px;color: #ffc107;margin-bottom: -5px;font-weight: 500;font-family: 'montserrat';letter-spacing: 2px">4.6<span style="font-size: 20px;padding-left: 5px">/ 5</span></h4>
					<div class="product-rating" style="color: #ffc107;font-size: 20px">
					...
					<p style="color: #aaa;font-size: 16px;letter-spacing: 1px;">11735 reviews</p>
					</div>
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				<!-- section title -->
				<div class="col-md-12">
					<div class="section-title supplier_sales">
						<h2 class="title">Fresh Sales</h2>
					</div>
				</div>
				<!-- section title -->
